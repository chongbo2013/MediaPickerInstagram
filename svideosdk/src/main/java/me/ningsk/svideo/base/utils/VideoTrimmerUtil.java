package me.ningsk.svideo.base.utils;

import android.content.Context;

import me.ningsk.common.utils.DensityUtil;
import me.ningsk.common.utils.MySystemParams;
import me.ningsk.svideo.base.supply.VideoTrimListener;
...
public class VideoTrimmerUtil {
    ...
    public static final int SCREEN_WIDTH_FULL = MySystemParams.getInstance().screenWidth;
    public static final int RECYCLER_VIEW_PADDING = DensityUtil.dip2px(35);
    ...
    private static final int THUMB_HEIGHT = DensityUtil.dip2px(50);
