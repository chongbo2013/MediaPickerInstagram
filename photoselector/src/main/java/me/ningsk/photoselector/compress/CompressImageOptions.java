...
public class CompressImageOptions implements CompressInterface {
    ...
    public static CompressInterface compress(Context context, CompressConfig config, ArrayList<MediaBean> selectedItems, CompressInterface.CompressListener listener) {
    ...
    private CompressImageOptions(Context context, CompressConfig config, ArrayList<MediaBean> selectedItems, CompressInterface.CompressListener listener) {
    ...
    public void compress() {
        ...
        for (MediaBean item : selectedItems) {
            if (item == null) {
    ...
    private void compress(final MediaBean item) {
        String path;
        if (item.isCrop()) {
    ...
    private void continueCompress(MediaBean item, boolean preSuccess, String... message) {
