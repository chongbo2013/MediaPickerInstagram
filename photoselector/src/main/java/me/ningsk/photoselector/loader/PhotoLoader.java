...
public class PhotoLoader {
    @NonNull
    public static ArrayList<MediaBean> getAllPhotos(@NonNull Context context, boolean showGif) {
    ...
    @NonNull
    private static ArrayList<MediaBean> getPhotos(@Nullable final Cursor cursor) {
        ArrayList<MediaBean> songs = new ArrayList<>();
    ...
    public static MediaBean getPhotoFromCursorImpl(Cursor cursor) {
        MediaBean photoBean = new MediaBean();
