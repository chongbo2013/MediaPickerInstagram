...
public class VideoLoader {
    @NonNull
    public static ArrayList<MediaBean> getAllVideos(@NonNull Context context) {
        Cursor cursor = makePhotoCursor(context, null, null, MediaStore.Video.Media.DEFAULT_SORT_ORDER);
        return getVideos(cursor);
    }

    @NonNull
    private static ArrayList<MediaBean> getVideos(@Nullable final Cursor cursor) {
    ...
    public static MediaBean getVideoFromCursorImpl(Cursor cursor) {
