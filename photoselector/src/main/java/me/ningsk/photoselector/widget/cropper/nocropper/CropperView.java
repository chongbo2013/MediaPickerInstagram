package me.ningsk.photoselector.widget.cropper.nocropper;
...
import me.ningsk.photoselector.widget.cropper.cropview.view.CropView;
import me.ningsk.photoselector.widget.cropper.cropview.view.CropperCallback;
import me.ningsk.photoselector.widget.cropper.cropview.view.DisplayHelper;
...
public class CropperView extends CropView {
    ...
    public Observable<Bitmap> getAllSelectedBitmap(ArrayList<MediaBean> mediaBeans) {
        saveLastInfo();
        if (cacheMap.isEmpty()) {
