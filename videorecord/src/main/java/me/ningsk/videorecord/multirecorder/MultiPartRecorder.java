package me.ningsk.videorecord.multirecorder;
...
import me.ningsk.videorecord.recorder.IVideoRecorder;
...
public class MultiPartRecorder extends VideoRecorderHandler implements IVideoRecorder {
    ...
    public AsyncTask<Part, Float, File> mergeVideoParts() {
        ...
        removeAllPart();
        return new VideoPartMergeTask(mOutputFile, mMergeListener, true, 2000).execute(parts);
    }
