...
public class VideoTrimFrameLayout extends FrameLayout implements SizeChangedNotifier {
    ...
    private OnVideoScrollCallBack mOnVideoCallback;
    ...
    private GestureDetector.OnGestureListener mOnGesture = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            if(mOnVideoCallback != null){
                mOnVideoCallback.onVideoSingleTapUp();
            }
            return false;
        }
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2,
            ...
            mOnVideoCallback.onVideoScroll(distanceX, distanceY);
