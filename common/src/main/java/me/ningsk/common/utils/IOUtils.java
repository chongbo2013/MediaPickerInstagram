...
import me.ningsk.common.stream.ByteArrayOutputStream;
import me.ningsk.common.stream.StringBuilderWriter;
...
public class IOUtils
{
            ...
            throws IOException
    {
        ...
        for (Iterator localIterator = lines.iterator(); localIterator.hasNext(); ) { Object line = localIterator.next();
            if (line != null) {
    ...
    public static long copyLarge(InputStream input, OutputStream output)
            throws IOException
    {
        return copyLarge(input, output, new byte[32768]);
    }
    ...
    public static long copyLarge(InputStream input, OutputStream output, long inputOffset, long length)
            throws IOException
    {
        return copyLarge(input, output, inputOffset, length, new byte[32768]);
    }
    ...
    public static long copyLarge(Reader input, Writer output)
            throws IOException
    {
        return copyLarge(input, output, new char[32768]);
    }
    ...
    public static long copyLarge(Reader input, Writer output, long inputOffset, long length)
            throws IOException
    {
        return copyLarge(input, output, inputOffset, length, new char[32768]);
    }
    ...
    public static boolean copyStream(InputStream is, RandomAccessFile os, CopyListener listener, int alreadyRead)
            throws IOException
    {
