...
/**
 * <p>描述：MediaPlayer播放器封装<p>
 * 作者：ningsk<br>
 * 日期：2018/10/30 18 06<br>
 * 版本：v1.0<br>
 */
public class JRMediaPlayer implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener,
    ...
    public JRMediaPlayer(Context context) {
        mContext = context;
        try {
