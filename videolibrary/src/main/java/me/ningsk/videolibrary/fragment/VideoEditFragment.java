...
import me.ningsk.baselibrary.utils.AudioPlayer;
import me.ningsk.baselibrary.utils.JRMediaPlayer;
...
import me.ningsk.filterlibrary.glfilter.base.GLImageOESInputFilter;
import me.ningsk.filterlibrary.glfilter.color.GLImageDynamicColorFilter;
...
import me.ningsk.videolibrary.bean.VideoEffect;
import me.ningsk.videolibrary.widget.IndicatorProgress;

/**
 * <p>描述：视频编辑界面<p>
 * 作者：ningsk<br>
 * 日期：2018/10/31 09 30<br>
 * 版本：v1.0<br>
 */
public class VideoEditFragment extends Fragment
    ...
    // 视频播放器
    private JRMediaPlayer mVideoPlayer;
    ...
    private void initVideoPlayer() {
        mVideoPlayer = new JRMediaPlayer(getContext());
        ...
        mVideoPlayer.setPlayStateListener(new JRMediaPlayer.PlayStateListener() {
            @Override
